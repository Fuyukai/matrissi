...
class Room(object):
    ...
    def name(self) -> Optional[str]:
        """
        :return: The name for this room, or None if it is unset.
        """
    ...
    def topic(self) -> Optional[str]:
        """
        :return: The topic for this room, or None if it is unset.
        """
    ...
    @property
    def history_visibility(self) -> HistoryVisibility:
        """
        :return: The visibility of historical events for this room.
        """

        evt = self.find_event("m.room.history_visibility", "", MatrixEventRoomHistoryVisibility)
        assert evt, "room is missing visibility event?"

        return evt.content.visibility
    ...
    async def send_event(
        ...
        *,
        ...
        :param returned_event_type: The type of the returned event, if ``wait_for_sync`` is True.
